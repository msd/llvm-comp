...
Value *WhileStmt::codegen()
{
    ...
    auto while_cond = BasicBlock::Create(TheContext, "while_cond", outer_function);
    auto while_loop = BasicBlock::Create(TheContext, "while_loop", outer_function);
    auto after_while = BasicBlock::Create(TheContext, "after_while", outer_function);
